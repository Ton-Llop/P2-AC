...
enum bpred_class {
  ...
  BPredAlloy,   /*Nuevo predictor alloyed*/
  BPred_NUM
};
...
struct bpred_dir_t {
  ...
  union {
    ...
    struct {
      ...
      int i_bits;
      unsigned int gbhr;
      unsigned int gbhr_mask;
      unsigned int pabht_size;
      int pabht_bits;
      unsigned int *pabht;
      unsigned int pht_size;
      unsigned char *tabla_pht_global;
      unsigned char *tabla_pht_local;
      unsigned char *tabla_pht_combi;
